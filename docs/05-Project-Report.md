...
**Individual Contribution:** ตารางแบ่งงานของสมาชิกทั้ง 6 คน พร้อมหน้าที่รับผิดชอบและหลักฐานที่ตรวจสอบย้อนกลับได้
อยู่ใน **รายงานฉบับส่ง §11.4 "การแบ่งงานและหลักฐานการมีส่วนร่วม"**

> 🔒 **ไม่ลงในคลังซอร์สโค้ดโดยเจตนา** — ตารางนั้นมีชื่อ-นามสกุลและรหัสนักศึกษาของสมาชิก
> ซึ่ง repo นี้เป็นสาธารณะ จึงใช้หลักเดียวกับ NFR-PRIV-01 (ไม่เผยแพร่ข้อมูลส่วนบุคคลของผู้ที่ไม่ได้
> เป็นเจ้าของ repo) เช่นเดียวกับที่ผู้ทดสอบ usability ถูกบันทึกเป็นรหัส P1–P8 แทนชื่อจริง
> ดูเหตุผลเต็มใน [02-AI-Usage-Log.md](02-AI-Usage-Log.md) entry #54

สิ่งที่ระบุได้ในที่สาธารณะ: repo มีผู้ commit เพียงคนเดียวเพราะกลุ่มตกลงให้สมาชิกคนหนึ่งเป็นผู้ดูแล
คลังและส่งโค้ดทั้งหมด งานของสมาชิกที่เหลือ (รวบรวม requirement · วิเคราะห์และออกแบบระบบ · เอกสาร ·
นำเสนอ · ทดสอบ) จึงไม่ปรากฏเป็นบันทึกใน git — **ข้อจำกัดนี้ระบุไว้ตรง ๆ ใน §11.4 ของรายงาน**
ไม่ปล่อยให้ตัวเลข commit เล่าเรื่องผิด · หลักฐานสาธารณะที่มีคือ [PR #23](https://github.com/kit-sinlapasa/sme-inventory-system/pull/23)
ซึ่งสมาชิกที่ไม่ใช่ผู้เขียนโค้ดเป็นผู้รีวิว
...
| รายการ | สถานะ |
|---|---|
| NFR-USE-01 (Usability Test) | ทดสอบกับผู้ที่ไม่ได้พัฒนาระบบ 7 คนแล้ว (คนนอกกลุ่ม 2 · สมาชิกกลุ่มที่ทำงานส่วนอื่น 5) สำเร็จ 7/7 เฉลี่ย 21.7 วิ · ตัดผู้พัฒนาออกจากกลุ่มตัวอย่าง · รอบสองเพิ่ม 3 คนตามที่ผู้รีวิว PR ติง · **สองกลุ่มย่อยทำเวลาต่างกันเพียง 0.3 วิ** บ่งว่าการอยู่กลุ่มเดียวกันไม่ได้ทำให้ได้เปรียบ — **แต่ n=7 ยังไม่พอยืนยัน ≥90% เชิงสถิติ** (rule of three: ขอบบนอัตราล้มเหลว 43%) ต้องราว 30 คน |
...
ตารางแบ่งงานรายบุคคลอยู่ใน **รายงานฉบับส่ง §11.4** — ไม่ลงใน repo สาธารณะเพราะมีชื่อและรหัส
นักศึกษา (เหตุผลเดียวกับ §⑤ Individual Contribution ด้านบน) · หลักฐานที่ตรวจสอบได้จากภายนอก
คือ [PR #23](https://github.com/kit-sinlapasa/sme-inventory-system/pull/23) ที่มีสมาชิกกลุ่มซึ่งไม่ใช่
ผู้เขียนโค้ดรีวิวจริง ตอบคำถามครบ 3 ข้อและไม่เห็นด้วย 2 ข้อ (ดู [06 §B5](06-Usability-Test-NFR-USE-01.md))
