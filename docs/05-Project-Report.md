...
| รายการ | สถานะ |
|---|---|
| NFR-USE-01 (Usability Test) | ทดสอบกับผู้ใช้ภายนอก 4 คนแล้ว สำเร็จ 4/4 เฉลี่ย 22.0 วิ (ตัดผู้พัฒนาออกจากกลุ่มตัวอย่าง) — **แต่ n=4 ยังไม่พอยืนยัน ≥90% เชิงสถิติ** (rule of three: ขอบบนอัตราล้มเหลว 75%) ต้องราว 30 คน |
