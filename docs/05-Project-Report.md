...
| รายการ | สถานะ |
|---|---|
| NFR-USE-01 (Usability Test) | ทดสอบกับผู้ใช้จริง 5 คนแล้ว สำเร็จ 5/5 เฉลี่ย 19.6 วิ — **แต่ n=5 ยังไม่พอยืนยัน ≥90% เชิงสถิติ** (rule of three: ขอบบนอัตราล้มเหลว ~60%) ต้องราว 30 คน |
