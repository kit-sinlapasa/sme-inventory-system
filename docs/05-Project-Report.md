...
| รายการ | สถานะ |
|---|---|
| NFR-USE-01 (Usability Test) | ทดสอบกับผู้ใช้ภายนอก 7 คนแล้ว สำเร็จ 7/7 เฉลี่ย 21.7 วิ (ตัดผู้พัฒนาออกจากกลุ่มตัวอย่าง · รอบสองเพิ่ม 3 คนตามที่ผู้รีวิว PR ติง) — **แต่ n=7 ยังไม่พอยืนยัน ≥90% เชิงสถิติ** (rule of three: ขอบบนอัตราล้มเหลว 43%) ต้องราว 30 คน |
