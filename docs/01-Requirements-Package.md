...
**Impact:** เพิ่ม `routers/reports.py`, `schemas/report.py`, `components/dashboard/` (palette + charts + panels) · เพิ่ม 16 tests รวมเป็น **85 tests** · แก้ `seed.py` (ข้อมูลย้อนหลัง) — ไม่กระทบ business logic เดิม
