...
## v1.0.0 — เวอร์ชันที่นำเสนอ (2026-08-25)

**Git tag:** `v1.0.0` · **Branch:** `main`

ดู commit ที่ถูก tag ได้ด้วย `git show v1.0.0` และเทียบการเปลี่ยนแปลงด้วย `git log v1.0.0`
...
ครบทุก FR-001 ถึง FR-015 และ NFR ทั้ง 7 ข้อ **ยกเว้น NFR-USE-01 ที่ยังขาดหลักฐานจากผู้ใช้จริง**
(ดูหัวข้อ Known issues) · รายละเอียดการ trace กลับไปหา requirement อยู่ใน
...
|---|---|---|---|
| K-01 | **NFR-USE-01 ยังไม่มีหลักฐานจากผู้ใช้จริง** | ไม่มีตัวเลขยืนยันว่า "ผู้ใช้ใหม่ 90% ทำสำเร็จใน 60 วินาที" — วัดส่วนที่เครื่องวัดได้แล้ว 10/10 แต่ตัวเลขจากคนต้องมาจากคนจริง | รันตาม [docs/06 §B](06-Usability-Test-NFR-USE-01.md) กับผู้ใช้ 5-8 คน |
...
|---|---|---|
| **v1.0.0** | 2026-08-25 | เวอร์ชันนำเสนอ — FR-001~014 + NFR ครบ · Dashboard เชิงวิเคราะห์ (CR-013) · deploy จริงบน Render |
