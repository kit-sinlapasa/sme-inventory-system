...
ครบทุก FR-001 ถึง FR-015 (15 ข้อ) และ NFR ทั้ง 8 ข้อ ครบทั้ง 7 หมวด · **NFR-USE-01 ทดสอบกับผู้ที่ไม่ได้พัฒนาระบบ 7 คนแล้ว
เมื่อ 2026-08-25 สำเร็จ 7/7** (คนนอกกลุ่ม 2 · สมาชิกกลุ่มที่ทำงานส่วนอื่น 5) โดยระบุข้อจำกัดเรื่องขนาดกลุ่มไว้ตรง ๆ (ดู K-01) · รายละเอียดการ trace กลับไปหา requirement อยู่ใน
...
|---|---|---|
| K-01 | **ปิดแล้ว 2026-08-25** — NFR-USE-01 ทดสอบกับผู้ที่ไม่ได้พัฒนาระบบ 7 คน สำเร็จ 7/7 เฉลี่ย 21.7 วิ (คนนอกกลุ่ม 2 · สมาชิกกลุ่ม 5) | เหลือข้อจำกัดที่ระบุไว้ตรง ๆ: **n=7 ยังไม่พอยืนยันเกณฑ์ ≥90% เชิงสถิติ** (ขอบบนอัตราล้มเหลว 43%) ต้องราว 30 คน · ตัดผู้พัฒนาออกจากกลุ่มตัวอย่างแล้ว · คงเลข K-01 ไว้ไม่ลบทิ้ง เพราะเอกสารอื่นเคยอ้างถึง |
| K-02 | **ปิดแล้ว 2026-08-25** — [PR #23](https://github.com/kit-sinlapasa/sme-inventory-system/pull/23) มีสมาชิกกลุ่มที่ไม่ใช่ผู้เขียนโค้ดรีวิวจริง ตอบคำถามครบ 3 ข้อ **และไม่เห็นด้วย 2 ข้อ** | ข้อติงถูกบันทึกทั้งที่รับและไม่รับพร้อมเหตุผลใน [docs/06 §B5](06-Usability-Test-NFR-USE-01.md) · ข้อ "อยากได้คน test เพิ่ม" **แก้จริงแล้ว** (n 4→7) · **PR ก่อนหน้า #1–#22 ยังคง `reviews = 0`** ไม่ย้อนไปแก้ เพราะรีวิวหลัง merge ไม่ใช่หลักฐานว่าตรวจก่อนขึ้น main |
