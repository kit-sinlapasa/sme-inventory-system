...
ครบทุก FR-001 ถึง FR-015 (15 ข้อ) และ NFR ทั้ง 8 ข้อ ครบทั้ง 7 หมวด · **NFR-USE-01 ทดสอบกับผู้ใช้ภายนอก 4 คนแล้ว
เมื่อ 2026-08-25 สำเร็จ 4/4** โดยระบุข้อจำกัดเรื่องขนาดกลุ่มไว้ตรง ๆ (ดู K-01) · รายละเอียดการ trace กลับไปหา requirement อยู่ใน
...
|---|---|---|
| K-01 | **ปิดแล้ว 2026-08-25** — NFR-USE-01 ทดสอบกับผู้ใช้ภายนอก 4 คน สำเร็จ 4/4 เฉลี่ย 22.0 วิ | เหลือข้อจำกัดที่ระบุไว้ตรง ๆ: **n=4 ยังไม่พอยืนยันเกณฑ์ ≥90% เชิงสถิติ** (ขอบบนอัตราล้มเหลว 75%) ต้องราว 30 คน · **ตัดผู้พัฒนาออกจากกลุ่มตัวอย่างแล้ว** · คงเลข K-01 ไว้ไม่ลบทิ้ง เพราะเอกสารอื่นเคยอ้างถึง |
