// หัวตารางที่คลิกเรียงลำดับได้ — ใช้ร่วมกันทั้งหน้าธีมสว่าง (Dashboard) และธีม brand เดิม
// (คำขอสั่งซื้อ) จึงไม่ผูกสีตายตัว ใช้ opacity บอกสถานะ active แทน ทำให้อ่านออกบนทุกพื้นหลัง
