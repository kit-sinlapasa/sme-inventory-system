...
| Usability test (NFR-USE-01) | ✅ **ทดสอบกับผู้ใช้ภายนอก 4 คนแล้ว (2026-08-25)** — สำเร็จ 4/4 ภายใน 60 วินาที เฉลี่ย 22.0 วิ (ตัดผู้พัฒนาออกจากกลุ่มตัวอย่าง) · ส่วนที่วัดด้วยเครื่องมือผ่าน 10/10 · ระบุข้อจำกัด n=4 ไว้ตรง ๆ ใน [docs/06](docs/06-Usability-Test-NFR-USE-01.md) |
